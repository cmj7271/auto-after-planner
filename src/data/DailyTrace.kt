...
sealed interface Origin {
    ...
    data class Web(val url: String, val domain: String /* URL 축소버전 */,
                   val visitId: Long? /* 브라우저 히스토리 id */, val profile: String? = "Default" /* 브라우저 프로필 */) : Origin

    @SerialName("Ai") @Serializable
    data class Ai(val conversationId: String?, val messageId: String?) : Origin
